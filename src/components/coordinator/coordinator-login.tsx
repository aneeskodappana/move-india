    ...
    <main className="grid min-h-screen place-items-center bg-forest-950 px-5 py-10">
      <div className="w-full max-w-md">
        ...
        <Card className="p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-stone-700">This is a separate prototype session. It cannot use a resident login to confirm pickup.</p>
          <div className="mt-5 rounded-control border border-marigold-300 bg-marigold-100 p-4">
            <p className="text-xs font-black uppercase tracking-wider text-forest-700">Fixed demo code</p>
          ...
          <form className="mt-6" onSubmit={props.onSubmit}>
            ...
            <Button className="mt-5 w-full" disabled={props.busy} type="submit">{props.busy ? "Opening…" : "Open collector queue"}</Button>
          </form>
